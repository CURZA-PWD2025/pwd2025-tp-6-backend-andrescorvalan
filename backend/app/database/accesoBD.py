        ...
        try:
            ...
            with conexion.cursor(dictionary=True) as un_cursor:
                ...
                if sql.strip().upper().startswith("INSERT") and un_cursor.lastrowid:
                    ...
                    # Para UPDATE y DELETE, devolvemos el número de filas afectadas
            ...
            print(f'Error de conexion a la BD o al intentar insertar datos: {una_excepccion}')
            return None
        finally:
            if conexion and conexion.is_connected():
                conexion.close()
        ...
        try:
            ...
            if sql.strip().upper().startswith("INSERT"):
                if self.cursor.lastrowid:
                    self.nuevo_id = self.cursor.lastrowid              # Devuelve el ID generado para INSERT
            return True
        except mysql.connector.Error as una_excepccion:
            print(f'Error de conexion a la BD o al intentar insertar datos: {una_excepccion}')
            return False