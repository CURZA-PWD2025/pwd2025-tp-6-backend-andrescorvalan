...
class ArticuloController:
    ...
    def create(data: dict) -> dict:
        ...
        if result==True:
            return {'estado':'ok', 'mensaje': 'Articulo creado con exito', 'objeto': nuevo_articulo.serializar()}
        elif result==False:
    ...
    def update(data: dict) -> dict:
        ...
        print('llego al update del back-controller')
        result = articulo.update()
        print('paso el update del model')
        if result==True:
            return {'estado':'ok', 'mensaje': 'Articulo actualizado con exito', 'objeto': articulo.serializar()}
        elif result==False:
